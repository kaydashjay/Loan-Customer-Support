...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <%-- <div class="jumbotron">
    ...
    <div>
        ...
        <asp:RequiredFieldValidator runat="server" id="reqFname" ForeColor="Red" controltovalidate="fname" errormessage="*" />
    </div>
    <br>
    <div>
        <asp:Label ID="lnameLabel" runat="server" Text="Last Name" AssociatedControlID ="lname"></asp:Label>
        <asp:TextBox ID="lname" runat="server"></asp:TextBox>
        <asp:RequiredFieldValidator runat="server" id="reqLname" ForeColor="Red" controltovalidate="lname" errormessage="*" />
    </div>
    <br>
        <div>
            <asp:Label ID="titleLabel" runat="server" Text="Case Title/ Subject" AssociatedControlID ="title" ></asp:Label>
            <asp:TextBox ID="title" runat="server"></asp:TextBox>
           <asp:RequiredFieldValidator runat="server" id="reqTitle" ForeColor="Red" controltovalidate="title" errormessage="*" />
         </div>
    <br />
      <div>
            ...
            <asp:RequiredFieldValidator runat="server" id="reqNumber" ForeColor="Red" controltovalidate="loannumber" errormessage="*" />
        </div>
    <br>
    <div>
        <label runat="server" for="description">Description</label>
        <textarea runat="server" id="description" cols="20" rows="2" required></textarea>
    </div>
    <br>
    <div>
